...
export const companies = [
	...
	},
	{
		...
		reviews: 18,
		description:
			"Award-winning design studio creating beautiful brands and digital experiences...",
	...
	},
	{
		...
		reviews: 67,
		description:
			"Strategic consulting firm providing business transformation and technology solutions...",
		services: [
			"Strategy Consulting",
				...
				<div className="space-y-6">
					...
					<div>
						...
						<p className="text-gray-600 mt-1">
							Discover and connect with qualified companies for your projects
						</p>
					</div>
