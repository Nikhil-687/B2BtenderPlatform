					...
					<div>
						{index > -1 ? (
							<div>
								...
								>
									<CardHeader style={{ margin: "10vh 2vw 6vh 2vw" }}>
										<div
									...
									<CardContent>
										<div
											...
											style={{ display: "contents", lineHeight: "5vh" }}
										>
											<div
												className="flex items-center gap-2"
												style={{
													...
													<CardContent>
                                                      ...
                                                      <span>{val.applications}</span>
														...
														>
															...
															>
																<Link
																	href={`/dashboard/companies/${val.Compid}/contact`}
																>
																...
																<Link
																	href={`/dashboard/companies/${val.Compid}`}
																>
