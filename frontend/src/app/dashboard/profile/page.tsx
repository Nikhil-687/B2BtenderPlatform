        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your company's core details and contact information</CardDescription>
            </CardHeader>
              ...
              {isEditing ? (
                ...
                <div className="space-y-4">
                  <p className="text-gray-700">
                    We are a leading technology company specializing in innovative software solutions for businesses of
                    all sizes. Our team of experienced developers and designers work together to create cutting-edge
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <span>123 Business Street, Suite 100, San Francisco, CA 94105</span>
                  </div>
                </div>
              )}
            </CardContent>
              ...
              <div className="flex flex-wrap gap-2">
                {services.map((service) => (
                  <div key={service} className="flex items-center gap-1">
                    ...
                    {isEditing && (
                      <Button size="sm" variant="ghost" className="h-6 w-6 p-0" onClick={() => removeService(service)}>
                        <X className="h-3 w-3" />
                      </Button>
                    )}
                  </div>
        ...
        <TabsContent value="portfolio" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Showcase your best work and completed projects</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="certifications" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your company's certifications, awards, and recognitions</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 border rounded-lg">
