...
export default function BrowseTendersPage() {
  ...
  const tenders = [
    ...
    },
    {
      ...
      description: "Comprehensive digital marketing strategy for healthcare technology product launch...",
    ...
    },
    {
      ...
      description: "Modern, intuitive UI/UX design for financial mobile application with focus on user experience...",
  ...
  const categories = ["All", "Technology", "Design", "Construction", "Marketing", "Consulting", "Manufacturing"]
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">Discover new business opportunities and submit your proposals</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-6">
          {filteredTenders.map((tender) => (
            <Card
              key={tender.id}
              className={`hover:shadow-lg transition-shadow ${tender.featured ? "ring-2 ring-blue-200 bg-blue-50/30" : ""}`}
            >
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="space-y-2">
                    ...
                    <CardTitle className="text-xl hover:text-blue-600 cursor-pointer">
                      <Link href={`/dashboard/browse/${tender.id}`}>{tender.title}</Link>
                    </CardTitle>
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-sm text-gray-500">{tender.applicants} applicants</div>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base mb-4">{tender.description}</CardDescription>
                <div className="flex items-center justify-between">
